    ...
    >
      <div className="absolute bottom-0 left-0 px-4 md:px-6 w-full h-full flex ">
        <div className="flex space-y-2 py-4 text-left items-end">
          ...
          />
          <h1 className="text-7xl font-bold tracking-tighter text-white ml-4 mb-8 py-4">Artist Name</h1>
        </div>
      </div>
    </section>
      <section className="container px-4 md:px-6 py-12 pl-4 pb-12 pr-8 sm:pl-12">
        ...
        <div className="flex flex-col gap-2 min-[400px]:flex-row justify-center py-12">
          <Link
            ...
            href="#"
          >
           <Icons.facebook className='inline-flex h-4 w-4 items-center justify-center rounded-md text-blue-500'/>
          </Link>
          <Link
