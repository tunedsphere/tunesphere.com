...
export function ShopSearchBar() {
  ...
  return (
    <>
      <div
        id="shop-search-bar"
        className="relative ml-2 flex grow flex-row items-center rounded-lg border border-muted hover:border-primary/50 lg:max-w-[24rem]"
      >
        <Command
        ...
        >
          ...
          {data && isOpen && (
            <CommandList
              ref={commandListRef}
              className="absolute left-0 right-0 mt-12 flex-grow rounded-sm border border-muted bg-popover py-1 shadow-lg"
            >
              <CommandEmpty
                className={cn(
