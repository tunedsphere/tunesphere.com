    ...
    >
      <div className="group">
        <AspectRatio ratio={1}>
          ...
          <Button
            variant="link"
            className="absolute bottom-2 left-2 flex h-8 w-8 items-center justify-center rounded-full bg-accent opacity-0 transition-opacity duration-300 hover:bg-none group-hover:opacity-100"
          >
            <Icon
              name="play"
              className="ml-1 fill-current text-primary hover:text-primary/80"
            />
          </Button>
        </AspectRatio>
      </div>
