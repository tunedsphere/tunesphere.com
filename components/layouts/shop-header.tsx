...
export function ShopHeader() {
  return (
    <div className="relative z-50 mt-[--headerHeight] w-full border-b border-muted bg-background-navbartop">
      {/* <div className="mx-auto flex w-full max-w-9xl items-center justify-between gap-2 overflow-clip px-4 py-2 align-middle lg:px-8 4xl:max-w-[66.66666666666666%]"> */}
      <Shell className="flex items-center justify-between py-3 pb-0">
