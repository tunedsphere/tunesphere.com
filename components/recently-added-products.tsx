...
export async function RecentlyAddedProducts() {
  await new Promise((resolve) =>
    setTimeout(resolve, delayRecentlyAddedProducts),
  )
  ...
  return (
    <section
      ...
      className="space-y-6 overflow-hidden px-0 py-8 md:pt-12 lg:pt-24"
    >
      <div className="flex w-full items-center px-2">
        <PageHeaderHeading
          size="xs"
          className="/90 flex-1 font-semibold underline decoration-primary underline-offset-4"
        >
          Recently Added
        </PageHeaderHeading>
        <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 overflow-visible text-center">
          <h2 className="font-heading text-3xl font-bold leading-[1.1] sm:text-3xl md:text-5xl"></h2>
        </div>
  ...
  return (
    ...
    >
      <div className="flex w-full items-center px-2">
        <PageHeaderHeading
          size="xs"
          className="flex-1 font-semibold underline decoration-primary underline-offset-4"
        >
          Recently Added
        </PageHeaderHeading>
        <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 overflow-visible text-center">
