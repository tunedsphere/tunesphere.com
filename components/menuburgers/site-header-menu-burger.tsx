  ...
  return (
    <>
      <div
        ...
        className="6xl:max-w-12xl invisible fixed left-0 right-0 top-0 z-20 mx-auto flex h-[--headerHeight] max-w-9xl items-center justify-end bg-white px-2 py-2 md:px-8"
      >
