import { mysqlTable, mysqlSchema, AnyMySqlColumn, serial, varchar, timestamp, json, tinyint, int, decimal, text, mysqlEnum } from "drizzle-orm/mysql-core"
...
export const products = mysqlTable("products", {
	...
	category: mysqlEnum("category", ['clothing','accessories','art','decorations']).default('clothing').notNull(),
